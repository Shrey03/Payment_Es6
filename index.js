...
module.exports = class extends Page {
    constructor(){
        super({title:"Home", sName:"SHREY|RONAK|PALLAVI"});
    }
    render(sPage) {
        const oJson = fetch("https://popup-restaurant-default-rtdb.firebaseio.com/meals.json").json();
        console.log(oJson);
        ...
        Object.keys(oJson).map((key) => {
            ...
            <form action="https://popup-meal-sms-chatbot.herokuapp.com/payment" method="post">
...
// https://serene-taiga-04277.herokuapp.com/